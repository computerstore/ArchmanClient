...
public class ServiceMemberEditorInput extends CRMEditorInput {

	private ServiceMember address;

	public ServiceMemberEditorInput(ServiceMember smember) {
		super(smember);
		this.address = smember;
	}

	public ImageDescriptor getImageDescriptor() {
		return ImageDescriptor.createFromFile(this.getClass(),
				"/help/icons/tux.png"); //$NON-NLS-1$
	}

	public String getName() {
		if (address.getFirstname() == null || address.getLastname() == null)
			return Messages.ServiceMemberEditorInput_EmptyServiceMemberName;
	...
	public Object getAdapter(Class adapter) {
		if (adapter == ServiceMember.class	|| adapter == Object.class) {
			return getBean();
		}
		System.out
				.println("[WARN] ServiceMemberEditorInput.getAdaper(Class): Adapter for not implemented class " //$NON-NLS-1$
