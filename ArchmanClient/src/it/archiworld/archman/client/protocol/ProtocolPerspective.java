...
public class ProtocolPerspective implements IPerspectiveFactory {
	...
	public void createInitialLayout(IPageLayout layout) {
		...
		IFolderLayout left = layout.createFolder("left", IPageLayout.LEFT, //$NON-NLS-1$
				0.3f, editorArea);
		left.addView(ProtocolTreeView.ID);
		left.addView(AddressTreeView.ID);

		layout
				.addPerspectiveShortcut("it.archiworld.archman.client.crm.perspective"); //$NON-NLS-1$
		layout
				.addPerspectiveShortcut("it.archiworld.archman.client.committee.perspective"); //$NON-NLS-1$
		layout
				.addActionSet("it.archiworld.archman.client.protocol.perspective.actionset"); //$NON-NLS-1$
	}
