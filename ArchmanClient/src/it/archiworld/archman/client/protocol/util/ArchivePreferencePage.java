...
public class ArchivePreferencePage extends PreferencePage implements IWorkbenchPreferencePage {

	protected TableViewer tableViewer;
	protected Button addButton;
	protected Button removeButton;
	protected List<String> archives = new ArrayList<String>();
	
	public static final String ARCHIVES = "preference.Archives"; //$NON-NLS-1$
	...
	public void init(IWorkbench workbench) {
		try {
			...
			archives = ((RCPEJBPreferenceStore)this.getPreferenceStore()).getStringList(ARCHIVES, null);
			if (archives==null) archives = new ArrayList<String>();
...
//	    		 }
	...
	private void createAddButton(Composite bparent) {
		...
		addButton.setText(Messages.getString("ArchivesPreferencePage.Button_Add")); //$NON-NLS-1$
	...
	private void createRemoveButton(Composite bparent) {
		...
		removeButton.setText(Messages.getString("ArchivesPreferencePage.Button_Remove")); //$NON-NLS-1$
	...
	private String openNewDialog() {
		 ...
		 String dialogTitle = Messages.getString("ArchivesPreferencePage.Title_NewArchive"); //$NON-NLS-1$
		 String dialogMessage = Messages.getString("ArchivesPreferencePage.DialogMessage_AddNewArchive"); //$NON-NLS-1$
		 IInputValidator validator = new IInputValidator() {
		 	public String isValid(String newText) {
		 		if ( archives.contains(newText) ) {
		 			return Messages.getString("ArchivesPreferencePage.InfoError_ArchiveExists"); //$NON-NLS-1$
		 		}
		 		if ( newText==null ) {
		 			return Messages.getString("ArchivesPreferencePage.InfoError_NullNotValidArchive"); //$NON-NLS-1$
		 		}
		 		return null;
			}  
		};
	...
	public boolean performOk() {
		super.performOk();
		// save values
	    ((RCPEJBPreferenceStore)this.getPreferenceStore()).setValue(ARCHIVES, archives);
	    return true;
	}
